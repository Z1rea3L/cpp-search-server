...
public: 
    ...
    void AddDocument(int document_id, const string& document, DocumentStatus status, const vector<int>& ratings) { 
        ...
        document_id_order_addition_.push_back(document_id); 
    } 
...
https://en.cppreference.com/w/cpp/container/vector/at "If pos is not within the range of the container, an exception of type std::out_of_range is thrown." можно не делать проверку
МОЖНО ЛУЧШЕ
...
private: 
    ...
    vector<int> document_id_order_addition_; 
